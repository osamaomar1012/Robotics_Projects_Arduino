#ifndef SURGICAL_CONFIG_HANDLER_H
#define SURGICAL_CONFIG_HANDLER_H

#include "App_Globals.h"

void drawSurgicalConfigScreen() {
    ...
    gfx.drawString("SURGICAL CONFIG", gfx.width()/2, 20);

    gfx.setFont(&fonts::DejaVu18);
    gfx.setTextColor(TFT_WHITE);
    gfx.setTextDatum(MC_DATUM);
    gfx.drawString("EXPOSURE CONTROLS PENDING", gfx.width()/2, gfx.height()/2);
